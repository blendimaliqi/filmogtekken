        ...
        <div>
          <div className="relative mt-5 rounded-3xl">
            <Image
              ...
              alt="poster"
            />
            <div className="absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition duration-200 bg-black bg-opacity-50">
              <div className="flex flex-col justify-between items-center h-full">
                <span className="text-white font-semibold text-2xl mt-40">
                  <div className="flex flex-col">
                    ...
                    <p className="font-light"> {movie.vote_count}</p>
                  </div>
                </span>
